...
export const metadata: Metadata = {
  ...
  title: "Trending — Aldriva",
  description: "Trending fundraising campaigns on Aldriva.",
  alternates: {
    canonical: `${getSiteUrl()}/fundraisers/trending`,
  },
  openGraph: {
    title: "Trending — Aldriva",
    description: "Trending fundraising campaigns on Aldriva.",
    url: `${getSiteUrl()}/fundraisers/trending`,
    siteName: "Aldriva",
    images: [{ url: "/aldriva-og-image-v2.png", width: 1200, height: 630, alt: "Trending" }],
  },
