...
export const metadata: Metadata = {
  ...
  title: "Needs Momentum — Aldriva",
  description: "Fundraisers that need a boost on Aldriva.",
  alternates: {
    canonical: `${getSiteUrl()}/fundraisers/needs-momentum`,
  },
  openGraph: {
    title: "Needs Momentum — Aldriva",
    description: "Fundraisers that need a boost on Aldriva.",
    url: `${getSiteUrl()}/fundraisers/needs-momentum`,
    siteName: "Aldriva",
    images: [{ url: "/aldriva-og-image-v2.png", width: 1200, height: 630, alt: "Needs Momentum" }],
  },
...
export default async function NeedsMomentumPage({
  searchParams,
}: {
  ...
  if (resolved?.q?.trim()) {
    ...
    params.set("filter", "needs-momentum");
