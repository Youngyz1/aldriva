# Aldriva Database Migration — Master Plan
...
Aldriva runs on a single Supabase project (`jnobheduodpvojwzbpra`) providing Postgres, Auth, Storage, and Realtime, fronted by a Next.js 16 App Router application (see root `CLAUDE.md`). The database layer consists of:
