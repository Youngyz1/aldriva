...
const ALLOW_RAW_MENTION = [
  "app/api/ai/chat/route.ts:122", // tool-loop model context + server log only
  "app/api/ai/chat/route.ts:157", // output-guard 422 keeps app-generated reason (see below)
  "app/api/ai/chat/route.ts:179", // status-classification temporary; generic returned
...
const ALLOW_RESPONSE = [
  ...
  "app/api/ai/chat/route.ts:160", // fixed 'Content rejected by Output Guard' + app guard reason
];
